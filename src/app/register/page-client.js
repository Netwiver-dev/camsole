...
import { FaUser, FaEnvelope, FaLock, FaCheck, FaExclamationCircle, FaUserGraduate } from 'react-icons/fa';
...
export default function RegisterClient() {
    ...
    return ( <
        ...
        <
        button className = { `px-4 py-2 focus:outline-none ${formData.role === 'student'
        ...
        Student <
        /button> <
        button className = { `px-4 py-2 focus:outline-none ${formData.role === 'teacher'
                                    ? 'bg-blue-600 text-white'
                                    : 'bg-white text-gray-700 hover:bg-gray-50'
                                    }` }
        onClick = {
        ...
        <
        label htmlFor = "name"
        className = "sr-only" > Full Name < /label> <
        ...
        onChange = { handleChange }
        className = { `appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border ${formData.confirmPassword && formData.password !== formData.confirmPassword
                                        ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                                        : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                                        } placeholder-gray-500 text-gray-900 focus:outline-none focus:z-10 sm:text-sm ${formData.role === 'student' ? '' : 'rounded-b-md'
                                        }` }
